========================================================================
    KONSOLENANWENDUNG: CV_Projekt-Projektübersicht
========================================================================

Diese CV_Projekt-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre CV_Projekt-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen CV_Projekt.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
